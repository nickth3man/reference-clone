...
def explore():
    # 1. Draft History
    check_endpoint("DraftHistory", drafthistory.DraftHistory, league_id='00', season_year_nullable='2023')
    ...
    check_endpoint("CommonTeamRoster", commonteamroster.CommonTeamRoster, team_id='1610612738', season='2023-24')
