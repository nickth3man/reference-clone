...
def migrate():
    ...
    try:
        ...
        if tables:
            ...
            tables_to_drop = [
                "coach_seasons", "coaches",
                "playoff_series",
                "hall_of_fame", "all_nba_teams", "awards",
                "team_payrolls", "player_contracts", "draft_picks",
                "player_splits",
                "team_season_stats",
                "team_game_stats", "box_scores", "games",
                "player_play_by_play_stats", "player_shooting_stats", "player_advanced_stats", "player_season_stats",
                "seasons", "franchises", "teams", "players"
            ]
            ...
            sequences = [
                "seq_player_season_stats_id", "seq_player_advanced_stats_id", "seq_player_shooting_stats_id",
                "seq_player_play_by_play_stats_id", "seq_box_scores_id", "seq_team_game_stats_id",
                "seq_team_season_stats_id", "seq_player_splits_id", "seq_draft_picks_id",
                "seq_player_contracts_id", "seq_team_payrolls_id", "seq_awards_id",
                "seq_all_nba_teams_id", "seq_hall_of_fame_id", "seq_playoff_series_id", "seq_coach_seasons_id"
            ]
