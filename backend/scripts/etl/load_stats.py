...
def load_stats():
    ...
    for row in all_stats:
        (pname, season, abbr, age, g, gs, mp, mpg,
            fg, fga, fg_pct,
            x3p, x3pa, x3p_pct,
            x2p, x2pa, x2p_pct,
            efg,
    ...
    print(f"Skipped Names: {skipped_names}, Ambiguous: {ambiguous_names}, Skipped Teams: {skipped_teams}")
