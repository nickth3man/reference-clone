        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <Link href="/teams" className="hover:bg-slate-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                Teams
              </Link>
              <Link href="/players" className="hover:bg-slate-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                Players
              </Link>
              <Link href="/games" className="hover:bg-slate-800 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                Games
              </Link>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-900 pb-4 px-4">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/teams" className="block hover:bg-slate-800 px-3 py-2 rounded-md text-base font-medium">
              Teams
            </Link>
            <Link href="/players" className="block hover:bg-slate-800 px-3 py-2 rounded-md text-base font-medium">
              Players
            </Link>
            <Link href="/games" className="block hover:bg-slate-800 px-3 py-2 rounded-md text-base font-medium">
              Games
            </Link>
          </div>
